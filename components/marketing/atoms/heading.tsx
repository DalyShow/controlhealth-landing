 ...
 * what carries the brand. Regular weight throughout; the steps differ only by
 * size, leading and tracking. Sizes are fluid between the phone and the 1440
 * frame so the ramp keeps its proportions rather than stepping at breakpoints.
 */
const RAMP = {
  1: "font-display font-normal text-[clamp(2.75rem,2.31rem+1.878vw,4rem)] leading-[1.15] tracking-[-0.03em]",
  2: "font-display font-normal text-[clamp(1.875rem,1.35rem+1.6vw,2.75rem)] leading-[1.15]",
  3: "font-display font-normal text-[clamp(1.25rem,1.1rem+0.47vw,1.5rem)] leading-[1.3]",
