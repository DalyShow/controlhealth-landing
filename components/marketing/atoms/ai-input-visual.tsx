...
const classes = {
  ...
  field:
    "stroke-figure-line-bright [fill:url(#input-glass)] [stroke-width:0.65]",
  fill: "fill-figure-line-dim stroke-none",
  mark: "fill-none stroke-figure-line [stroke-width:1]",
  caret: "fill-figure-accent",
  sparkle:
    "fill-none stroke-figure-accent [stroke-width:1.3] [transform-box:fill-box] [transform-origin:center]",
  highlight:
    "fill-none stroke-figure-accent [stroke-dasharray:17_83] [stroke-width:1.8] [filter:drop-shadow(0_0_3px_var(--color-figure-accent))]",
} as const;
