 ...
 * full cycle per beat, so a 58 bpm reading pulses 58 times a minute.
 *
 * Unlike the section figures this keeps beating rather than stopping after a
 * couple of cycles: it is a pulse, and a heart that beats twice and gives up
 * is not the reading we want. It does stop once it scrolls out of sight,
 * which is the only reason this is a client component.
 */
const classes = {
...
export const HeartbeatIcon = ({ beatsPerMinute }: HeartbeatIconProperties) => {
  ...
  return (
    <svg
      ...
      style={{
        animationDuration: `${SECONDS_PER_MINUTE / beatsPerMinute}s`,
