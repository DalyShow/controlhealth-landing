...
const classes = {
  ...
  dot: "fill-transparent stroke-figure-line-dim [stroke-width:1]",
  halo: "fill-none stroke-figure-accent [stroke-width:1] [transform-box:fill-box] [transform-origin:center]",
  sweep:
    "stroke-figure-accent [stroke-width:1.3] [filter:drop-shadow(0_0_4px_var(--color-figure-accent))]",
  card: "stroke-figure-line-bright [fill:url(#panel-glass)] [stroke-width:0.65]",
  ...
  pick: "fill-figure-line-bright stroke-figure-line-bright [stroke-width:1] [transform-box:fill-box] [transform-origin:center]",
} as const;
