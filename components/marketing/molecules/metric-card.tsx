 ...
 */
const classes = {
  root: "flex w-[280px] flex-col rounded-2xl border border-hero-glass-edge bg-hero-glass p-4 backdrop-blur-md max-sm:w-[248px] max-sm:p-3.5 [&>*+*]:mt-4 [&>*+*]:border-hero-glass-rule [&>*+*]:border-t [&>*+*]:pt-4 max-xl:[&>*+*]:mt-3 max-xl:[&>*+*]:pt-3",
} as const;

export const MetricCard = ({ children }: MetricCardProperties) => (
