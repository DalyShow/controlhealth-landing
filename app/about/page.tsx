...
/**
 * The three belief blocks. Copy is from the live page, with two missing spaces
 * in the middle paragraph repaired.
 */
const BELIEFS = [
  {
    heading: "Concierge-level access to your health information",
    paragraphs: [
      "For most people, navigating their own health means navigating alone. Records scattered across systems that don't talk to each other. Test results that never translate to anything actionable.",
    ],
  },
  {
...
const AboutPage = () => (
  <main className={classes.page}>
    ...
    />
    <ProseSection blocks={BELIEFS} eyebrow="Why we built this" />
